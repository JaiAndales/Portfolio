...
export function CategoryPostsSection({ category, posts }: CategoryPostsSectionProps) {
  return (
    <section className="py-16 px-6 max-w-7xl mx-auto">
      ...
      {posts.length === 0 ? (
        <div className="glass-panel p-12 text-center">
          <p className="text-slate-600 dark:text-slate-400 text-lg">No posts found in this category.</p>
